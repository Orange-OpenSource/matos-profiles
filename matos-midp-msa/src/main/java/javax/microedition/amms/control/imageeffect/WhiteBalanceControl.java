...
@Real("com.francetelecom.rd.fakemidp.jsr234.WhiteBalanceControlImplem")
@ClassDone
public interface WhiteBalanceControl extends javax.microedition.amms.control.EffectControl{
// Fields
...
// Methods
    public abstract int setColorTemp(int arg1);
