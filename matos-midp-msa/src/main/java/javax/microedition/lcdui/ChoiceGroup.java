...
public class ChoiceGroup extends Item implements Choice{
    ...
    public ChoiceGroup(@FieldSet("label")String a0,int a1){ }
    @Code({"string=arg3[0];", "image=arg4[0];"})
    public ChoiceGroup(@FieldSet("label") String a0,int a1,java.lang.String[] a2,Image[] a3){
    ...
    public int append(@FieldSet("string")String a0,@FieldSet("image")Image a1){ return 0;
    }
