...
public class Connection {
	@ArgsRule(value="siemens.Connection", pos={1})
    public Connection(String a) {}
    public void send(byte[] a) throws com.siemens.mp.NotAllowedException {
    }
    
    public void setListener(@FieldSet("list")@CallBackRegister("connection")ConnectionListener a) {
    }
    @FieldGet("list")
