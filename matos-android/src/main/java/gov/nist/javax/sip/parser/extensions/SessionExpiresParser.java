...
public class SessionExpiresParser
  extends gov.nist.javax.sip.parser.ParametersParser{
  // Constructors

  public SessionExpiresParser(java.lang.String arg1){
    super((gov.nist.javax.sip.parser.Lexer) null);
  }
  protected SessionExpiresParser(gov.nist.javax.sip.parser.Lexer arg1){
    super((gov.nist.javax.sip.parser.Lexer) null);
  }
  // Methods
