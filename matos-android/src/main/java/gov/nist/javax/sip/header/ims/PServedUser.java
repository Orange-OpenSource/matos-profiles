...
public class PServedUser
  extends gov.nist.javax.sip.header.AddressParametersHeader  implements javax.sip.header.ExtensionHeader, SIPHeaderNamesIms, PServedUserHeader
{
  // Constructors

  public PServedUser(gov.nist.javax.sip.address.AddressImpl arg1){
