...
public class PAssertedService
  extends gov.nist.javax.sip.header.SIPHeader  implements javax.sip.header.ExtensionHeader, PAssertedServiceHeader, SIPHeaderNamesIms
{
  // Constructors

  protected PAssertedService(java.lang.String arg1){
