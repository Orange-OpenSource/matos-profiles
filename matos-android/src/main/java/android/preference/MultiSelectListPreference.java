...
public class MultiSelectListPreference
  ...
  public MultiSelectListPreference(android.content.Context arg1, android.util.AttributeSet arg2){
    super((android.content.Context) null, (android.util.AttributeSet) null, 0);
  }
  @com.francetelecom.rd.stubs.annotation.CallBackRegister("onCreate")
  public MultiSelectListPreference(android.content.Context arg1){
    super((android.content.Context) null, (android.util.AttributeSet) null, 0);
  }
  // Methods
  ...
  @com.francetelecom.rd.stubs.annotation.FieldGet("mValues")
  public java.util.Set<java.lang.String> getValues(){
    return (java.util.Set) null;
  }
  public void setValues(@com.francetelecom.rd.stubs.annotation.FieldSet("mValues") java.util.Set<java.lang.String> arg1){
  }
  @com.francetelecom.rd.stubs.annotation.CallBack("onCreate")
