...
public final class CRLDistributionPoints
  ...
  private CRLDistributionPoints(java.util.List<DistributionPoint> arg1, byte [] arg2){
    super();
  }
  // Methods

  public static CRLDistributionPoints decode(byte [] arg1) throws java.io.IOException{
    return (CRLDistributionPoints) null;
  }
