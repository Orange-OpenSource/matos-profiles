...
public final class InfoAccessSyntax
  ...
  private InfoAccessSyntax(java.util.List<?> arg1, byte [] arg2) throws java.io.IOException{
    super();
  }
  // Methods
  ...
  public static InfoAccessSyntax decode(byte [] arg1) throws java.io.IOException{
    return (InfoAccessSyntax) null;
  }
